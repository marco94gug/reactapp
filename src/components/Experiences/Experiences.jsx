        ...
        <div ref={myRef} className="Experiences">
            ...
            <div className='experiences-container'>
                ...
                <ul className="experiences-list">
                        <li className={id === "deck" ? "exp-li active" : "exp-li"} onClick={(e) => handeOnClickLi(e)} id="deck"><p>Deck</p> </li>
                        <li className={id === "photography" ? "exp-li active" : "exp-li"} onClick={(e) => handeOnClickLi(e)} id="photography"><p>Photographer</p></li>
